...
@implementation WYChatListTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        [_lblDetail setTextColor:[[UIColor binaryColor:@"ffffff"] colorWithAlphaComponent:0.5]];
        _lblDetail.text = [NSString stringWithFormat:@"来自%@的好友请求", _userName];
        
        _lblName = [UILabel new];
        [_lblName setFont:[UIFont boldSystemFontOfSize:16.f]];
        [_lblName setTextColor:[UIColor binaryColor:@"ffffff"]];
        _lblName.text = @"好友消息";
